...
@interface KidProfileViewController ()

@end

@implementation KidProfileViewController
@synthesize navigationItem;
@synthesize imageViewForKid;
...
- (void)viewDidLoad
{
    ...
    imageViewForKid.layer.cornerRadius=45.0f;
    imageViewForKid.userInteractionEnabled=YES;
